import { version, unref, inject, defineComponent, ref, provide, createElementBlock, createVNode, Fragment, reactive, computed, watch, nextTick, onMounted, onBeforeUnmount, Teleport, Transition, h, shallowReactive, Suspense, hasInjectionContext, isVNode, withModifiers, mergeProps, useSSRContext, createApp, effectScope, getCurrentInstance, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, toRef, resolveComponent, withCtx, createTextVNode, toDisplayString, shallowRef, isReadonly, isRef, markRaw, isShallow, isReactive, toRaw } from 'vue';
import { $ as $fetch$1, m as defu, n as createHooks, c as createError$1, o as isSamePath, w as withQuery, p as hasProtocol, q as parseURL, t as isScriptProtocol, v as joinURL, x as toRouteMatcher, y as createRouter$1, z as sanitizeStatusCode, A as withoutTrailingSlash, B as klona, C as parse, D as getRequestHeader, E as destr, F as isEqual, G as setCookie, H as getCookie, I as deleteCookie } from '../runtime.mjs';
...
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode, ssrInterpolate, ssrRenderAttrs } from 'vue/server-renderer';
import 'node:http';
import 'node:https';
import 'node:zlib';
import 'node:stream';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-RK-Gf2LU.mjs').then((m2) => m2.default || m2)
  }
];
...
const redirect_45global = /* @__PURE__ */ defineNuxtRouteMiddleware(async (to, from) => {
});
...
const useDirectusAuth = () => {
  ...
  const loginWithProvider = async (provider, redirectOnLogin) => {
    ...
    const redirect = `${(void 0).location.origin}${redirectOnLogin ?? route.fullPath}`;
...
const layouts = {
  default: () => import('./default-ChlWd_rP.mjs').then((m2) => m2.default || m2)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const pageData = {
      heading: error.value.statusCode,
      desc: error.value.statusMessage,
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLayout, _attrs, {
        default: withCtx((_2, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="error-page"${_scopeId}><div class="container d-flex flex-column align-items-center justify-content-center"${_scopeId}><h1${_scopeId}>Error ${ssrInterpolate(pageData == null ? void 0 : pageData.heading)}</h1><div class="body-small"${_scopeId}>${(pageData == null ? void 0 : pageData.desc) ?? ""}</div>`);
            _push2(ssrRenderComponent(_component_Button, {
              to: pageData == null ? void 0 : pageData.button_link,
              classes: "small green",
              arrow: true
            }, {
              default: withCtx((_3, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(pageData == null ? void 0 : pageData.button_text)}`);
                } else {
                  return [
                    createTextVNode(toDisplayString(pageData == null ? void 0 : pageData.button_text), 1)
                  ];
                }
              }),
              _: 1
            ...
            return [
              createVNode("div", { class: "error-page" }, [
                createVNode("div", { class: "container d-flex flex-column align-items-center justify-content-center" }, [
                  createVNode("h1", null, "Error " + toDisplayString(pageData == null ? void 0 : pageData.heading), 1),
                  createVNode("div", {
                    class: "body-small",
                    innerHTML: pageData == null ? void 0 : pageData.desc
                  }, null, 8, ["innerHTML"]),
...
export { _export_sfc as _, useRuntimeConfig as a, useNuxtApp as b, entry$1 as default, injectHead as i, resolveUnrefHeadInput as r, useRequestEvent as u };
